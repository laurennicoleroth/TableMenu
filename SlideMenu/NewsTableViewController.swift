...
class NewsTableViewController: UITableViewController, MenuTransitionManagerDelegate {
    ...
    @IBAction func unwindToHome(_ segue: UIStoryboardSegue) {
        ...
        let sourceController = segue.source as! ExploreFiltersViewController
//        self.title = sourceController.currentItem
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let exploreFiltersViewController = segue.destination as! ExploreFiltersViewController
        ExploreFiltersViewController.transitioningDelegate = menuTransitionManager
